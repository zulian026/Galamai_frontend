import { ArrowLeft, Edit3, Calendar, Eye, Share2, Loader2, Globe, FileText } from "lucide-react";
import { useState } from "react";

export default function ArtikelPreview({ artikel, onClose, onEdit, onPublish }) {
  ...
  const isNew = () => {
    if (!artikel.created_at) return false;
    const createdDate = new Date(artikel.created_at);
    const now = new Date();
  ...
  const isDraft = artikel.status === 'draft';
  const isPublished = artikel.status === 'published';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Preview Artikel</h1>
                <p className="text-gray-600 mt-1">
                  Lihat bagaimana artikel akan tampil untuk pembaca
                </p>
              </div>
              {/* Status Badge */}
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                <strong>Draft Mode:</strong> Artikel ini belum dipublish dan hanya bisa dilihat oleh admin. 
                Klik <strong>"Publish Artikel"</strong> untuk mempublikasikan.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex items-center gap-4 text-gray-500 text-sm">
                ...
                <div className="text-gray-400">
                  • {formatRelativeTime(artikel.created_at)}
                </div>
              </div>
            </div>
          ...
          <div className="p-8">
            <div 
              ...
              dangerouslySetInnerHTML={createMarkup(artikel.description)}
              style={{
                lineHeight: '1.8',
                color: '#374151'
              }}
          ...
          <div className="p-8 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Artikel ini telah dilihat {artikel.views || 0} kali
              </div>
              {isPublished && (
                <div className="flex items-center gap-2">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className={`text-sm mt-1 ${
                ...
                {isDraft 
                  ? 'Artikel ini masih dalam mode draft. Klik "Publish Artikel" untuk mempublikasikan ke semua pembaca.'
                  : 'Ini adalah tampilan preview artikel Anda. Pembaca akan melihat artikel dengan layout yang sama seperti ini.'
                }
              </p>
            </div>
          </div>
